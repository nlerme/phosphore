...
public class PreferencesDialogController
{
	...
	public class PreferencesDialog_OkHandler implements ActionListener
	{
		public void actionPerformed( ActionEvent e )
		{
			...
			dp.setDisplayNormalsState(m_PreferencesDialog.getDisplayNormalsState());
			...
			dm = m_PreferencesDialog.getSelectedDrawingMode();
			if( dm != null ) dp.setDrawingMode(dm);

			p = m_PreferencesDialog.getSelectedProjection();
			if( p != null ) dp.setProjection(p);
