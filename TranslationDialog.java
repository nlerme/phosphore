...
public class TranslationDialog extends JDialog
{
	...
	private JButton m_Translate;
	private JButton m_Cancel;
	private MainWindow m_MainWindow;


	public TranslationDialog( MainWindow mw, String title )
	{
		super(mw, title, true);
	...
	private void createComponents()
	{
		...
		m_Translate = new JButton("Translate");
	...
	public void setListener( TranslationDialogController c )
	{
		m_Translate.addActionListener(c.new TranslationDialog_TranslateHandler());
		m_Cancel.addActionListener(c.new TranslationDialog_CancelHandler());
	}
