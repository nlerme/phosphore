	...
	public void processNormals()
	{
		...
		while( itFacets.hasNext() )
		{
			...
			if( p1 != null && p2 != null && p3 != null )
			{
				...
				Vector3D faceNormal = Vector3D.normalize(Vector3D.crossProduct(new Vector3D(p1, p3), new Vector3D(p1, p2)));
				
				// Store it in facet (keep for backward compatibility if needed)
				f.normal = faceNormal;
				m_Geometry.setFacet(i, f);
